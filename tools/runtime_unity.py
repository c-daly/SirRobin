...
class RuntimeUnityProfile:
    """Named viewer calibration, separate from the biological kernels."""
...
BASELINE_RUNTIME_PROFILE = RuntimeUnityProfile(
    name="baseline",
...
EVOLUTION_DEMO_RUNTIME_PROFILE = RuntimeUnityProfile(
    name="evolution-demo",
    description=(
        "fivefold observation window and mutation exposure for the Unity demo"
    ),
